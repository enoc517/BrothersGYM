...
namespace BrothersGYM.Controllers
{
    public class SalasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Idsala,Cupo,Descripcion")] Sala sala)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idsala,Cupo,Descripcion")] Sala sala)
        {
            if (id != sala.Idsala)
            {
                return NotFound();
